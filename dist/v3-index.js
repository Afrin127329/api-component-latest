                      ...
                      init: function () {
                        ...
                        this.on("change:attributes:selectedData", function () {
                          var n,
                            ...
                            a = c.getById("productId").view,
                            i = c.getById("productPrice").view,
                            r = c.getById("productQuantity").view;
                          (a.el.innerHTML = t.id),
                    ...
                    return h(this, function (h) {
                      switch (h.label) {
                        ...
                        case 4:
                          return (
                            (H = h.sent()),
                            console.error("Error in Fetching Data", H),
                            [3, 5]
                          );
                        case 5:
                          return (
                            e.BlockManager.add("link-block", {
                              ...
                              content: {
                                ...
                                content:
                                  '<a class="fs-6 link-block-span" href="#"><span>Link</span></a>',
                              },
                            }),
                      ...
                      switch (o.label) {
                        case 0:
                          (n = "https://chepapest.com/api/dev/products"),
                            ...
                            (o.label = 1);
                        case 1:
                          return o.trys.push([1, 4, , 5]), [4, fetch(n)];
                        case 2:
                          if (!(i = o.sent()).ok)
                            throw new Error("Failed to fetch data");
                          return [4, i.json()];
                        ...
                        case 4:
                          return (
                            (s = o.sent()),
                            console.log("Error in Fetching Data", s),
                            [3, 5]
                          );
                        case 5:
                          return [2];
